...
\begin{eqnarray}
  ...
  %% &=& A-\hat{A} - A + \mathbf{A}(\mathbf{A}_t^\top \mathbf{A}_t)^{-1}\mathbf{A}_t^\top(\hat{A}_t-A_t) + \mathbf{A}(\mathbf{A}_t^\top \mathbf{A}_t)^{-1}\mathbf{A}_t^\top A_t\\
  %% &=& -\hat{A}  + \mathbf{A}(\mathbf{A}_t^\top \mathbf{A}_t)^{-1}\mathbf{A}_t^\top(\hat{A}_t-A_t) + A\\
  %% &=& A-\hat{A}  + \mathbf{A}(\mathbf{A}_t^\top \mathbf{A}_t)^{-1}\mathbf{A}_t^\top(\hat{A}_t-A_t)\\
  %% &=& A - \hat{A} - H_{A_t}A + H_{A_t} \hat{A}\\
\end{eqnarray}
